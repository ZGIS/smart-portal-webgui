...
import {Result, IGeoFeature, IGeoFeatureCollection} from './result';
...
export class ResultService {
   ...
   */
  getResults(query: string, fromDate: string, toDate: string, bboxWkt: string): Promise<IGeoFeatureCollection> {
